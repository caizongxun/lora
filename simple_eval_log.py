#!/usr/bin/env python3
"""
Ultra-Simple LoRA Evaluation Script - WITH LOG FILE OUTPUT
All output saved to log file for easy debugging

Usage:
    python simple_eval_log.py
...
log_print("\n" + "="*80)
log_print("🚀 Simple LoRA Evaluation - WITH LOG FILE")
log_print("="*80)
...
try:
    ...
    log_print(f"✅ Success! datasets version: {datasets.__version__}")
except Exception as e:
    log_print(f"❌ FAILED: {type(e).__name__}: {e}")
    log_print(f"\nFull traceback:")
    log_print(traceback.format_exc())
